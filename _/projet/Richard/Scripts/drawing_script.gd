...
@export_range(1,20)var brush_radius : int = 10
...
func _drawing(pixel_position : Vector2i, image : Image, color : Color, material : StandardMaterial3D, brush : Array[Vector2i]) -> void:
	for offset in brush:
